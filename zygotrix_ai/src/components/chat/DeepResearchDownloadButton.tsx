...
const DeepResearchDownloadButton: React.FC<DeepResearchDownloadButtonProps> = ({ content, timestamp }) => {
    return (
        <PDFDownloadLink
            document={<DeepResearchReport content={content} timestamp={timestamp || new Date().toLocaleString()} />}
