...
export const GwasWidget: React.FC<GwasWidgetProps> = ({ gwasData }) => {
  ...
  return (
    <div className="my-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 overflow-hidden shadow-sm">
      ...
      <div className="px-4 py-3 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-b border-gray-300 dark:border-gray-600">
        ...
        {tabs.map((tab) => (
          ...
          >
            ...
            {tab.count !== undefined && tab.count > 0 && (
              <span className="ml-2 px-2 py-0.5 text-xs rounded-full bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300">
                {tab.count}
              </span>
            )}
            {activeTab === tab.id && (
