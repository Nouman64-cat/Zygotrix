...
interface SequenceMrnaStrandProps {
    sequence: string;
}

// mRNA Single Strand Visualization Component
const SequenceMrnaStrand: React.FC<SequenceMrnaStrandProps> = ({
    sequence
}) => {
...
export default SequenceMrnaStrand;
