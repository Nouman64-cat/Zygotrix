...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/zygotrix",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="relative mt-[-1px] overflow-hidden bg-gradient-to-b from-slate-900 via-slate-950 to-black text-slate-200">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 lg:py-20">
        ...
        <div className="mb-16 lg:mb-20">
          <div className={`relative mx-auto max-w-2xl rounded-2xl border transition-all duration-500 ${
            isFocused 
            ...
            <div className="relative text-center">
              ...
              <form className="mx-auto max-w-md" onSubmit={handleSubscribe}>
                <div className={`relative flex items-center gap-2 rounded-full p-1.5 transition-all duration-300 ${
                  isFocused
                ...
                <div className="h-6 mt-3">
                  {message && (
                    <p className={`text-sm flex items-center justify-center gap-2 animate-fade-in ${
                      message.type === "success" ? "text-[#10B981]" : "text-red-400"
                    }`}>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Zygotrix. All rights reserved.
          </p>
