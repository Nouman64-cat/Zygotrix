...
const BrowseCoursesPage = () => {
  ...
  // Removed showFilters state (no longer needed with sidebar layout)
  ...
  return (
    <div className="space-y-8">
      {/* Search Bar (full width, above grid and filters) */}
      ...
      <div className="flex flex-col gap-8 md:flex-row">
        {/* Course Grid */}
        <main className="flex-1 order-1 md:order-none">
        ...
        <aside className="md:w-80 w-full md:sticky md:top-8 flex-shrink-0 order-2 md:order-none md:ml-8">
