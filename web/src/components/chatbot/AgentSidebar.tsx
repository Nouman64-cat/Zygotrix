...
export const AgentSidebar: React.FC<AgentSidebarProps> = ({
  ...
  return (
    <>
      {/* Backdrop overlay for smaller screens when sidebar is open */}
      {!isCollapsed && (
        <div
          className="fixed inset-0 bg-black/30 backdrop-blur-sm z-30 2xl:hidden"
      ...
      <div
        className={`
          ...
          /* Fixed/overlay positioning on smaller screens (below 2xl), static on large screens */
          ${!isCollapsed
            ? 'fixed right-0 top-16 z-40 h-[calc(100vh-4rem)] 2xl:relative 2xl:top-0 2xl:h-full 2xl:z-auto'
            : 'h-full'
          }
        `}
      >
