      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div className="hidden md:flex items-center justify-between px-6 py-3 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shrink-0">
          <div className="flex items-center gap-2">
            ...
            {user?.subscription_status === "pro" && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs font-bold text-amber-700 bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/50 dark:to-orange-900/50 dark:text-amber-300 rounded-full border border-amber-200 dark:border-amber-700/50 shadow-sm">
        ...
        <div className="md:hidden flex items-center justify-between p-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shrink-0">
          <div className="flex items-center gap-2">
            ...
            {user?.subscription_status === "pro" && (
              <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-bold text-amber-700 bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/50 dark:to-orange-900/50 dark:text-amber-300 rounded-full border border-amber-200 dark:border-amber-700/50">
