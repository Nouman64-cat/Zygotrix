...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Zygotrix - Founder Nouman Ejaz</title>
        <meta name="description" content="Meet the founder of Zygotrix, Nouman Ejaz. Building reliable genetic analysis tools." />
        {/* Open Graph tags for Social Media Previews */}
        <meta property="og:title" content="About Zygotrix" />
        <meta property="og:description" content="Nouman Ejaz, Founder & Creator." />
                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  {founder && (
                    <div
                      role="button"
                      tabIndex={0}
                      onClick={() => window.location.href = `/team/${founder.slug}`}
                      onKeyDown={(e) => {
                        if (e.key === 'Enter' || e.key === ' ') {
                          window.location.href = `/team/${founder.slug}`;
                        }
                      }}
