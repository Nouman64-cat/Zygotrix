...
class ProgressRepository:
    ...
    def update_assessment_status(
        ...
        if not progress_doc:
            print(
                f"❌ No progress document found for user {user_id}, course {course_slug}"
            )
            return False
        ...
        for module in modules:
            if module.get("module_id") == module_id:
                ...
                print(
                    f"✅ Updated module {module_id}: status={module['assessment_status']}, score={module['best_score']}, attempts={module['attempt_count']}"
                )
                module_updated = True
                break
