          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center mb-2">
                ...
                />
                <label htmlFor="useRandomSeed" className="text-sm font-medium text-gray-700">
                  Use random seed
                </label>
              </div>
              {!useRandomSeed && (
        ...
        {result && (
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm text-gray-600">Target GC Content</p>
                <p className="text-lg font-semibold text-gray-900">
                  {(result.gc_content * 100).toFixed(1)}%
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Actual GC Content</p>
                <p className="text-lg font-semibold text-gray-900">
                  {(result.actual_gc * 100).toFixed(2)}%
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">AT Content</p>
                <p className="text-lg font-semibold text-gray-900">
